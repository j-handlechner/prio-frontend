<template>
  <p>abweichungLeftUp {{ deviationLeftUp }}</p>
  <p>abweichungLeftBottom {{ deviationLeftBottom }}</p>
  <p>abweichungRightUp {{ deviationRightUp }}</p>
  <p>abweichungRightBottom{{ deviationRightBottom }}</p>

  <p>valueLeftUp {{ valueLeftUp }}</p>
  <p>valueLeftBottom {{ valueLeftBottom }}</p>
  <p>valueRightUp {{ valueRightUp }}</p>
  <p>valueRightBottom{{ valueRightBottom }}</p>

  <p>percentageLeft {{ percentageLeft }}</p>
  <p>percentageRight {{ percentageRight }}</p>
  <p>percentageLeftTop {{ percentageLeftTop }}</p>
  <p>percentageLeftBottom {{ percentageLeftBottom }}</p>
  <p>percentageRightTop {{ percentageRightTop }}</p>
  <p>percentageRightBottom {{ percentageRightBottom }}</p>
...
<script setup>
  ...
  const expectedPerField = props.totalvalue / 4

  // calculate all abweichungen
  const deviationLeftUp = computed(() => props.topleft - expectedPerField);
  const deviationLeftBottom = computed(() => props.bottomleft - expectedPerField);
  const deviationRightUp = computed(() => props.topright - expectedPerField);
  const deviationRightBottom = computed(() => props.bottomright - expectedPerField);

  // calculate all values with accounted deviations
  const valueLeftUp = computed(() => expectedPerField + deviationLeftUp.value - deviationLeftBottom.value / 4 - deviationRightUp.value / 4 - deviationRightBottom.value / 4 - deviationLeftUp.value / 4)
  const valueLeftBottom = computed(() => expectedPerField + deviationLeftBottom.value - deviationLeftUp.value / 4 - deviationRightUp.value / 4 - deviationRightBottom.value / 4 - deviationLeftBottom.value / 4)
  const valueRightUp = computed(() => expectedPerField + deviationRightUp.value - deviationLeftUp.value / 4 - deviationLeftBottom.value / 4 - deviationRightBottom.value / 4 - deviationRightUp.value / 4)
  const valueRightBottom = computed(() => expectedPerField + deviationRightBottom.value - deviationLeftUp.value / 4 - deviationLeftBottom.value / 4 - deviationRightUp.value / 4 - deviationRightBottom.value / 4)
